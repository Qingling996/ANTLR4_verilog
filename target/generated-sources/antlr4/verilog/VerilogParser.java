...
public class VerilogParser extends Parser {
	...
	public static final int
		...
		CARET_TILDE=129, ONESTEP=130, STRING=131, SIMPLE_IDENTIFIER=132, ESCAPED_IDENTIFIER=133, 
		AND3=134, PLUS=135, MINUS=136, STAR=137, DIV=138, MOD=139, LOG_AND=140, 
		LOG_OR=141, LOG_NOT=142, LOG_EQ=143, LOG_NEQ=144, CASE_EQ=145, CASE_NEQ=146, 
		BIT_AND=147, BIT_OR=148, BIT_NOT=149, BIT_XOR=150, BIT_XNOR=151, REDUCE_NOR=152, 
		REDUCE_NAND=153, LEFT_SHIFT=154, RIGHT_SHIFT=155, SHRA=156, SHLA=157, 
		LESS=158, LESS_EQ=159, GREATER=160, GREATER_EQ=161, ASSIGN_EQ=162, ASSIGN_LE=163, 
		ASSIGN_NB=164, TICK=165, AT=166, HASH=167, DOLLAR=168, QUESTION=169, COLON=170, 
		SEMI=171, COMMA=172, DOT=173, LPAREN=174, RPAREN=175, LBRACK=176, RBRACK=177, 
		LBRACE=178, RBRACE=179, PLUS_COLON=180, MINUS_COLON=181, IMPLIES=182, 
		STAR_GT=183, SINGLE_QUOTE=184, BINARY_VALUE=185, BINARY_DIGIT=186, SIZE_DIGIT=187, 
		UDP_EDGE_SYMBOL=188, DOLLAR_SETUP=189, DOLLAR_HOLD=190, DOLLAR_WIDTH=191, 
		DOLLAR_RECOVERY=192, DOLLAR_SKEW=193, BINARY_0=194, BINARY_1=195, BINARY_UPPER_0=196, 
		BINARY_UPPER_1=197, QUOTED_0=198, QUOTED_1=199, ARROW=200, ARROW_ARROW=201, 
		PULSE=202, FULLSKEW=203, POLARITY_OP=204, WS=205, BLOCK_COMMENT=206, LINE_COMMENT=207, 
		BINARY_NUMBER=208, DECIMAL_NUMBER=209;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'>='", "'='", null, null, "'`'", "'@'", "'#'", "'$'", "'?'", "':'", 
			"';'", "','", "'.'", "'('", "')'", "'['", "']'", "'{'", "'}'", "'+:'", 
			"'-:'", "'=>'", "'*>'", "'''", null, null, null, null, "'$setup'", "'$hold'", 
			"'$width'", "'$recovery'", "'$skew'", "'1'b0'", "'1'b1'", "'1'B0'", "'1'B1'", 
			"''0'", "''1'", "'->'", "'->>'", "'pulse'", "'fullskew'"
		};
	}
	...
	public final Module_declarationContext module_declaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2014310310285967598L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 8282792796389L) != 0) || ((((_la - 132)) & ~0x3f) == 0 && ((1L << (_la - 132)) & 17592186044419L) != 0)) {
				{
				{
				setState(542);
				module_item();
	...
	public final Combinational_bodyContext combinational_body() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 142)) & ~0x3f) == 0 && ((1L << (_la - 142)) & 17592320262145L) != 0) );
			setState(635);
			match(ENDTABLE);
			}
		}
	...
	public final Sequential_bodyContext sequential_body() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 142)) & ~0x3f) == 0 && ((1L << (_la - 142)) & 87961064439809L) != 0) );
			setState(651);
			match(ENDTABLE);
			}
		}
	...
	public final Level_symbolContext level_symbol() throws RecognitionException {
		...
		try {
			...
			setState(683);
			_la = _input.LA(1);
			if ( !(((((_la - 142)) & ~0x3f) == 0 && ((1L << (_la - 142)) & 17592320262145L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Output_symbolContext output_symbol() throws RecognitionException {
		...
		try {
			...
			setState(689);
			_la = _input.LA(1);
			if ( !(((((_la - 136)) & ~0x3f) == 0 && ((1L << (_la - 136)) & 1125908496777217L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final PortContext port() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((((_la - 132)) & ~0x3f) == 0 && ((1L << (_la - 132)) & 70368744177667L) != 0)) {
					{
					setState(916);
					port_expression();
					}
	...
	public final Generate_regionContext generate_region() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1437775023388525550L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & -4611683947730763719L) != 0)) {
				{
				{
				setState(1042);
				generate_item();
	...
	public final Generate_case_statementContext generate_case_statement() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 154248287237455876L) != 0) || ((((_la - 109)) & ~0x3f) == 0 && ((1L << (_la - 109)) & 72058693776375811L) != 0) || _la==LPAREN || _la==LBRACE );
			setState(1101);
			match(ENDCASE);
			}
		}
	...
	public final Named_parameter_assignmentContext named_parameter_assignment() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 154248287237439492L) != 0) || ((((_la - 109)) & ~0x3f) == 0 && ((1L << (_la - 109)) & 576461852046065667L) != 0) || _la==LPAREN || _la==LBRACE) {
				{
				setState(1200);
				expression(0);
				}
	...
	public final Blocking_assignmentContext blocking_assignment() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==REPEAT || ((((_la - 166)) & ~0x3f) == 0 && ((1L << (_la - 166)) & 51539607555L) != 0)) {
				{
				setState(1295);
	...
	public final Loop_statementContext loop_statement() throws RecognitionException {
		...
		try {
			...
			case FOR:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((((_la - 42)) & ~0x3f) == 0 && ((1L << (_la - 42)) & 281475178037249L) != 0) || ((((_la - 132)) & ~0x3f) == 0 && ((1L << (_la - 132)) & 70368744177667L) != 0)) {
					{
					setState(1415);
					for_initialization();
					}
	...
	public final Gate_instantiationContext gate_instantiation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 167)) & ~0x3f) == 0 && ((1L << (_la - 167)) & 25769803777L) != 0)) {
				{
				setState(1498);
				delay3();
				}
	...
	public final Unary_operatorContext unary_operator() throws RecognitionException {
		...
		try {
			...
			setState(1605);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 154248287237439492L) != 0) || ((((_la - 109)) & ~0x3f) == 0 && ((1L << (_la - 109)) & 1099713216515L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Binary_operatorContext binary_operator() throws RecognitionException {
		...
		try {
			...
			setState(1607);
			_la = _input.LA(1);
			if ( !(_la==AND || _la==OR || ((((_la - 110)) & ~0x3f) == 0 && ((1L << (_la - 110)) & 4275034319224833L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Constant_function_callContext constant_function_call() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 154248287237439492L) != 0) || ((((_la - 109)) & ~0x3f) == 0 && ((1L << (_la - 109)) & 72058693776375811L) != 0) || _la==LPAREN || _la==LBRACE) {
				{
				setState(1678);
				constant_expression(0);
				setState(1683);
		...
		try {
			...
			case CASE:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 154248287237455876L) != 0) || ((((_la - 109)) & ~0x3f) == 0 && ((1L << (_la - 109)) & 576461852046065667L) != 0) || _la==LPAREN || _la==LBRACE );
				setState(2021);
				match(ENDCASE);
				}
				break;
	...
	public final Seq_blockContext seq_block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 282931048200L) != 0) || ((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 6917529064148303875L) != 0) || ((((_la - 168)) & ~0x3f) == 0 && ((1L << (_la - 168)) & 12884902913L) != 0)) {
				{
				{
				setState(2089);
				statement();
	...
	public final System_task_enableContext system_task_enable() throws RecognitionException {
		...
		try {
			...
			if (_la==LPAREN) {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 154248287237439492L) != 0) || ((((_la - 109)) & ~0x3f) == 0 && ((1L << (_la - 109)) & 576461852046065667L) != 0) || ((((_la - 173)) & ~0x3f) == 0 && ((1L << (_la - 173)) & 35L) != 0)) {
					{
					setState(2142);
					task_arg_list();
					}
	...
	public final Task_declarationContext task_declaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 282931048200L) != 0) || ((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 6917529064148303875L) != 0) || ((((_la - 168)) & ~0x3f) == 0 && ((1L << (_la - 168)) & 12884902921L) != 0)) {
				{
				{
				setState(2189);
				statement_or_null();
	...
	public final Function_declarationContext function_declaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 42)) & ~0x3f) == 0 && ((1L << (_la - 42)) & 469762049L) != 0) || ((((_la - 117)) & ~0x3f) == 0 && ((1L << (_la - 117)) & 576460752303423551L) != 0)) {
				{
				setState(2216);
				function_data_type();
				}
	...
	public final Specify_blockContext specify_block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 38)) & ~0x3f) == 0 && ((1L << (_la - 38)) & 17592194441249L) != 0) || ((((_la - 174)) & ~0x3f) == 0 && ((1L << (_la - 174)) & 1015809L) != 0)) {
				{
				{
				setState(2257);
				specify_item();
	...
	public final Unary_module_path_operatorContext unary_module_path_operator() throws RecognitionException {
		...
		try {
			...
			setState(2385);
			_la = _input.LA(1);
			if ( !(((((_la - 142)) & ~0x3f) == 0 && ((1L << (_la - 142)) & 4065L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Binary_module_path_operatorContext binary_module_path_operator() throws RecognitionException {
		...
		try {
			...
			setState(2387);
			_la = _input.LA(1);
			if ( !(((((_la - 135)) & ~0x3f) == 0 && ((1L << (_la - 135)) & 7975807L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	private static final String _serializedATNSegment0 =
		...
		"h\u0001h\u0001h\u0003h\u0511\bh\u0001h\u0001h\u0001h\u0001i\u0001i\u0001"+
		"i\u0003i\u0519\bi\u0001i\u0001i\u0001i\u0001j\u0001j\u0003j\u0520\bj\u0001"+
		"j\u0001j\u0001j\u0001j\u0005j\u0526\bj\nj\fj\u0529\tj\u0001j\u0001j\u0003"+
		"j\u052d\bj\u0001k\u0001k\u0001k\u0001k\u0001k\u0001k\u0003k\u0535\bk\u0001"+
		"l\u0001l\u0001l\u0005l\u053a\bl\nl\fl\u053d\tl\u0001l\u0001l\u0001l\u0001"+
		"l\u0003l\u0543\bl\u0001m\u0001m\u0003m\u0547\bm\u0001m\u0001m\u0005m\u054b"+
		"\bm\nm\fm\u054e\tm\u0001m\u0001m\u0003m\u0552\bm\u0001n\u0001n\u0001n"+
		"\u0001n\u0001o\u0001o\u0001o\u0001o\u0001p\u0001p\u0001p\u0001p\u0003"+
		"p\u0560\bp\u0001p\u0001p\u0001q\u0001q\u0001q\u0001q\u0005q\u0568\bq\n"+
		"q\fq\u056b\tq\u0001q\u0001q\u0001r\u0001r\u0001r\u0001r\u0001r\u0001r"+
		"\u0001r\u0003r\u0576\br\u0001s\u0001s\u0001s\u0001s\u0001s\u0001s\u0001"+
		"s\u0001s\u0001s\u0001s\u0001s\u0001s\u0001s\u0001s\u0001s\u0001s\u0001"+
		"s\u0003s\u0589\bs\u0001s\u0001s\u0003s\u058d\bs\u0001s\u0001s\u0003s\u0591"+
		"\bs\u0001s\u0001s\u0003s\u0595\bs\u0001t\u0001t\u0001t\u0001t\u0003t\u059b"+
		"\bt\u0001u\u0001u\u0001v\u0001v\u0001v\u0005v\u05a2\bv\nv\fv\u05a5\tv"+
		"\u0001w\u0001w\u0001w\u0003w\u05aa\bw\u0001x\u0001x\u0001y\u0001y\u0001"+
		"y\u0005y\u05b1\by\ny\fy\u05b4\ty\u0001z\u0001z\u0001z\u0001z\u0001z\u0001"+
		"z\u0001z\u0001z\u0003z\u05be\bz\u0001{\u0001{\u0001{\u0001{\u0001{\u0001"+
